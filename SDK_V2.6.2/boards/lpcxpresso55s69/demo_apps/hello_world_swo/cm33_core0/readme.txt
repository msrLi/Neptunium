...
2.  Connect Jlink plus probe to the SWD connector(P1).
...
Running the demo
================
The log below shows the output of the hello world swo demo in the JlinkerSWOView window and the demo will continuous print it with SW1 pressed:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SWO: hello_world
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
