...
static uint32_t s_srcBuffer1[BUFF_LENGTH]                      = {1, 2, 3, 4};
static uint32_t s_srcBuffer2[4]                                = {11, 22, 33, 44};
static uint32_t s_destBuffer[BUFF_LENGTH * DMA_DESCRIPTOR_NUM] = {0x00};
