...
public:
    ...
    int processOptions()
    {
		...
		if (!m_imgConfFilePath.empty() && m_family != kLPC_skbootFamily && m_family != kKinetisK3Family) 
		{
			Log::log(Logger::ERROR, ((string)"\'-J\' or \'-T\' parameter can be used only with target family " + LPC55XX + ", " + NIOBE4MINI + ", " + RT6XX + ", " + RT5XX + " or kinetisk3.\n").c_str());
			return 0;
		}
